...
control MyIngress(inout headers hdr,
    ...
    action srv4_next_c_sid_swap() {
        bit<8> subnet_id= hdr.ipv4.dstAddr[31:24];;
        bit<8> current_sid = hdr.ipv4.dstAddr[23:16];
        bit<8> postfix = hdr.ipv4.dstAddr[7:0];
        hdr.ipv4.dstAddr[31:24] = subnet_id;
        hdr.ipv4.dstAddr[23:16] = postfix;
        hdr.ipv4.dstAddr[7:0] = current_sid;
    }
    table srv4_my_sid {
      key = {
